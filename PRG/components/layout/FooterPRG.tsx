...
export const FooterPRG = () => {
    ...
    const lightModeTextColor = "text-[#ae60dc]"; // Purple Rain Galore, Quick Links, Contact Us
                ...
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className={`font-headline text-xl font-bold ${theme === 'light' ? '!text-[#ae60dc]' : 'text-white'}`}>Purple Rain Galore</h3>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className={`font-cta font-semibold text-lg mb-4 ${theme === 'light' ? '!text-[#ae60dc]' : 'text-white'}`}>Quick Links</h4>
                    ...
                    {/* Services */}
                    <div>
                        <h4 className="font-cta font-semibold text-lg mb-4 text-white">Our Services</h4>
                        <ul className="space-y-2">
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className={`font-cta font-semibold text-lg mb-4 ${theme === 'light' ? '!text-[#ae60dc]' : 'text-white'}`}>Contact Us</h4>
